...
Diskriminan merupakan sebuah fungsi yang menerima vektor input $\textbf{x}$ dan mengelompokkannya ke dalam K kelas. Kelas tersebut disimbolkan sebagai $C_k$,
...
Dalam persamaan tersebut, $\textbf{w}$ disebut sebagai vektor bobot, sedangkan $\textbf{w}^T$ menyatakan transpose dari vektor bobot. 
