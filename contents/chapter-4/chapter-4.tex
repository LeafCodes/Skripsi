...
\section{Hasil Optimal untuk Parameter}

Tabel menunjukkan hasil dari pencarian nilai parameter optimal untuk model yang dilakukan dengan metode grid search
dengan menggunakan parameter jumlah iterasi dan metode yang digunakan
pada dataset.
